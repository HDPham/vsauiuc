...
function Events() {
  ...
  const upcEvents = [
    {
      ...
      admins: ['VSA', 'PSA', 'TASC'],
      get startTime() {
        return this.startDate.toLocaleTimeString(undefined, {
          hour: 'numeric',
          minute: 'numeric',
        });
      },
      get endTime() {
        return this.endDate.toLocaleTimeString(undefined, {
          hour: 'numeric',
          minute: 'numeric',
        });
      },
  ...
  return (
    <Container id="events" className="mt-4 fade-in">
      <Nav
        tabs
        className="text-center justify-content-center justify-content-sm-start"
      >
        <NavItem>
          <NavLink
