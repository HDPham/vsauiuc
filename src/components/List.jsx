        ...
        >
          <Col xs={8} md={5} lg={4} xl={3}>
            <div className="event-date text-center font-weight-bold">
              ...
              <div className="rounded-bottom event-day">{event.day}</div>
            </div>
            <img
              src={event.img}
              alt={event.name}
            ...
            <div className="text-secondary font-weight-bold">
              ...
              {event.locationSecondary ? (
                <>
                  ...
                  <p className="ml-5">
                    ...
                    <span>{event.locationSecondary}</span>
                  </p>
                </>
              ) : (
                <span>{event.location}</span>
              ...
              event.endDate.toDateString() ? (
                ...
                <>
                  ...
                  <p className="ml-5 text-secondary font-weight-bold">
                    <FontAwesomeIcon icon="clock" />
                    <span>
                      {event.startDate.toLocaleDateString()} at{' '}
                      {event.startTime} to {event.endDate.toLocaleDateString()}{' '}
                      at {event.endTime}
                    </span>
                  </p>
                </>
              ...
              <p>
                ...
                <span>
                  Hosted by&nbsp;
                  {event.admins.length > 0 && event.admins.length > 1
                    ? event.admins.length > 2
                      ? `${event.admins
                          .slice(0, -1)
                          .join(', ')}, and ${event.admins.slice(-1)}`
